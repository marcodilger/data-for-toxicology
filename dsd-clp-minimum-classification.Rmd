...
There is experimental data from 2 studies. Both values quite clearly indicate cat. 1 instead of 2, the current CLH category. The registation dossier confirms these values (with a "creative" way of reporting effect concentration). Looks like HCN is currently not appropriately classified in the CLP.
...
* It seems the most recent data is not included in eChemPortal. It looks like more recent data than the 2017 IUCLID database dump is found, but registrations or updates after April or May 2018 seem to be missing. For assessing the appropriateness of the minimum classification this is, at most, only a minor drawback.
