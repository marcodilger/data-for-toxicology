...
studies_oral_name %>% 
  ...
  View
```
ToDo: remove those that dont have name, nor cas nor echa.
there shouldn't be any entries witout EC number actually because we're using ECHA dissemiated data here -> all should have an EC number,

e.g. exemplary check OR: lookup by WebChem using PubChem
