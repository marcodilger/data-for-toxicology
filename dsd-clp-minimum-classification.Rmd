...
data_oral_combined_cas <- clp_minimum %>% 
  ...
  full_join(studies_oral_cat_derived %>% 
               select(name, substance_number, number_type, category_from_exp, reliability, effect_level_quantifier, effect_level_dose, unit) %>% 
...
ggplotly(plot_substances_of_concern)

```
To continue: add custom/additional data to plotly output: reliability, numericla study results
